...
import indi.augusttheodor.aurora.adapter.AdminApplyAdapter;
...
public class AdminApplyActivity extends AppCompatActivity implements HttpInterface , RecyclerViewListenerInterface {

    public RecyclerView recycler;
    public AdminApplyAdapter adapter;
    public AdapterItems<AdminApplyViewHolder.AdminApplyObject> items;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.adapter=new AdminApplyAdapter(this.items,this,this.group_id);
    ...
    public void onNext() {
        AuroraApplication.httpPackage.asyncRequest(
                getString(R.string.backend_website)+getString(R.string.backend_admin_apply).replace("0",group_id)+p,
                "GET",
                null,
                "APPLY",
                this,
        ...
        switch (tag){
            case "APPLY":
                if(response.code()==200){
                    ...
                    List<AdminApplyViewHolder.AdminApplyObject> nl=AuroraApplication.httpPackage.gson.fromJson(s,new TypeToken<List<AdminApplyViewHolder.AdminApplyObject>>(){}.getType());
                    for(AdminApplyViewHolder.AdminApplyObject nlo:nl){
                        this.items.add(nlo);
                    }
